package com.therxmv.napoleon.ui.rating.viewmodel
...
import com.therxmv.napoleon.ui.rating.viewmodel.utils.RatingUiState
...
class RatingViewModel(
    ...
    private val _inputsState = MutableStateFlow<Map<RatingItemModel, InputState>>(emptyMap())
...
//            val result = napoleonApi.getRatingBySpecialty(
...
//        }
    ...
    fun updateInputByIndex(item: RatingItemModel, value: String) {
